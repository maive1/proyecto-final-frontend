        ...
        <div className="row">
          <div className="col s12 m8 l6 offset-m2 offset-l3">
            <div className="card-panel card_info">
              ...
              <span className="color-text-2 text-body-home">Queremos atenderte lo más rápido posible, recuerda que nuestros profesionales abordarán tu situación de forma confidencial.</span>
            ...
            <Link className="link_style text-body" to="/registerpro">Soy profesional <i className="material-icons proiconstyle">account_circle</i></Link>            
